...
import { background, main, text, primary } from "../components/Colors";
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 6 }}>
        ...
        >
          <View style={{ paddingVertical: algoHeight / 50 }}>
            <View
              style={{
                flexDirection: "row",
                alignItems: "stretch",
                ...
                <View>
                  ...
                  >
                    ...
                    <View style={{ flexGrow: 1, flexDirection: "row" }}>
                      <Text
                        style={{
                          paddingHorizontal: algoHeight / 40,
                          color: text,
                          fontSize: algoHeight / 20,
                          alignSelf: "center",
                          fontFamily: "Popins",
                          width: algoWidth / 15,
                        }}
